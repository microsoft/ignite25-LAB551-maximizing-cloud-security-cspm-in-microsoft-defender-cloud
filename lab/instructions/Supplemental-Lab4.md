...
![Diagram of the process flow of tasks for this lab.](https://github.com/MicrosoftLearning/AZ500-AzureSecurityTechnologies/blob/master/Instructions/media/microsoft-sentinel-diagram.png)

## Instructions

## Lab files:

- **changeincidentseverity.json** - supplied in github
...
3. On the **Edit template** blade, click **Load file**, locate the [Allfiles\Labs\15\changeincidentseverity.json](https://github.com/MicrosoftLearning/AZ500-AzureSecurityTechnologies/blob/master/Allfiles/Labs/15/changeincidentseverity.json) file and click **Open**.
