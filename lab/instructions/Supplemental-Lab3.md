...
7. By default, just-in-time access for the VM uses these settings:
   ...
   ![Screen capture of the just-in-time access for vm configuration screen.](https://github.com/MicrosoftLearning/AZ500-AzureSecurityTechnologies/blob/master/Instructions/media/just-in-time-vm-access.png)
...
2. Select the VM to which you want to connect, and open the **Connect** page.
   ...
   ![Screen capture of the Connect to a Virtual Machine using JIT.](https://github.com/MicrosoftLearning/AZ500-AzureSecurityTechnologies/blob/master/Instructions/media/vm-connection-for-vm1.png)
