...
## 🔥LAB551: Maximizing Cloud Security: CSPM in Microsoft Defender Cloud
...
- Enable Microsoft Defender for Cloud CSPM
- Use the Attack Path Analysis tool to review potential attack paths
- Use Query Builder to find resources that might be at risk
...
| Take Training | [Defender for Cloud training](https://learn.microsoft.com/en-us/training/modules/microsoft-defender-cloud-threat-protection/) | Learn more about Defender for Cloud |
...
<table>
<tr>
    <td align="center"><a href="http://r-c-Stewart.com/mikekinsman">
        <img src="https://github.com/r-c-stewart.png" width="100px;" alt="Robert Stewart"/><br />
        <sub><b> Robert Stewart</b></sub></a><br />
